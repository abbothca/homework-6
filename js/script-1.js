...
function iterativeOddSumTo(number) {//для додатніх значень рахуємо суму
        ...
        for (let i = 1; i <= number; i += 2) {          //лічильник з 1, бо натуральні числа йдуть з 1; збільшуємо на 2 - бо перебираємо лише непарні
            sum += i;                 //на кожній ітерації збільшуємо суму на значення лічильника, якщо число непарне, або на 0, якщо парне
        }
